...
function buildAssets() {
    ...
    if [ -f "../src/addArchive.cpp" ]; then
        echo "Found existing addArchive.cpp, reading encryption key..."
        ENCRYPTION_KEY=$(grep -o 'addArchive(".*", ".*"' ../src/addArchive.cpp | sed -e 's/addArchive(".*", "//' -e 's/"//')
    else
